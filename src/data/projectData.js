export const projects = [
    ...
    },
    {
        ...
        description:
            "A sleek clone of the Spotify web app with playlist browsing, playback controls, and dynamic album/track rendering. Styled with Tailwind CSS and powered by the Spotify API.",
    },
    {
    ...
    },
    {
        ...
        description:
            "A pixel-perfect clone of Netflix's user interface built with React and Tailwind CSS. Features a responsive layout, horizontal carousels, hover effects, and dynamic movie listing using TMDB API.",
    },
];